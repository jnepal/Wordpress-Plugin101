<?php
/**
 * Populates the Meta Box (input fields container)
 */
...
function dwwp_meta_callback($post) {
    ...
    ?>
        ...
        <div class="meta-row">
            ...
            <div class="meta-td">
                <input type="date" size=10 class="dwwp-row-content" name="date_listed" id="date-listed" value="<?php if (!empty ($dwwp_stored_meta['date_listed'])) echo esc_attr($dwwp_stored_meta['date_listed'][0]); ?>" required/>
            </div>
        </div>
        <div class="meta-row">
            <div class="meta-th">
            ...
            <div class="meta-td">
                <input type="date" size=10 class="dwwp-row-content" name="application_deadline" id="application_deadline" value="<?php if (!empty($dwwp_stored_meta['application_deadline'])) echo esc_attr($dwwp_stored_meta['application_deadline'][0]); ?>" required/>
            </div>
        </div>
        <div class="meta">
            <div class="meta-th">
        ...
        <?php
        // Using wp-editor for flexibility instead of default editor
